    ...
    while True:
        ...
        if results.multi_hand_landmarks:
            ...
            grid = path_to_grid(path, size=GRID_SIZE, input_width=w, input_height=h)
             ...
             # Affichage de la trajectoire pour debug
            ...
            print(f"✅ Packet envoyé : {success}" if success else "❌ Échec envoi")

            # Affichage de la trajectoire sur la grille LED à chaque frame
            grid = path_to_grid(path, size=GRID_SIZE, input_width=w, input_height=h)
            ...
            # # Envoi UDP
            # success = udp_sender.send_packet(packet)
            # print("✅ Packet envoyé : {succes} " if success else "❌ Échec envoi")
